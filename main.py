...
async def lifespan(app: FastAPI):
    ...
    async with VLLMClient() as client:
        ...
        # Voice details mapping for the custom voices
        voice_genders = {
            'English_Speaker243_female': 'female',
            'English_Speaker246_male': 'male',
            'English_Speaker248_female': 'female'
        }
        
        # Generate voice details with correct language and gender
        VOICE_DETAILS = [
            VoiceDetail(
                name=voice,
